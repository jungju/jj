...
func newRunCommand(exec executor, stdout, stderr io.Writer) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			cfg.AutoPRExplicit = cmd.Flags().Changed("auto-pr")
	...
	cmd.Flags().BoolVar(&cfg.AutoPR, "auto-pr", false, "when on the default branch, create a jj work branch and open or reuse a GitHub PR after validation passes")
